  ...
  return (
   ...
   <div className="content-box flex f-column">
     ...
     <div className="controll flex  flex-between text-white">
       ...
       <div className='flex center' >{boxStyle === 'large-movie'?<Link to={`/MoviePage`} state={{ typeId:data.id,name:data.media_type||type?data.media_type||type:'movie' }} className='watch text-white '>watch Now</Link>:null}
